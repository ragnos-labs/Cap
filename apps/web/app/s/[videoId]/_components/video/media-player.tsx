	...
	return (
		<Tooltip {...tooltipProps} delayDuration={tooltipDelayDuration}>
			...
			<TooltipContent
				...
				className="flex items-center gap-2 border bg-gray-1 px-2 py-1 font-medium text-gray-12 data-[side=top]:mb-3.5  [&>span]:hidden"
			>
				<p>{tooltip}</p>
				{Array.isArray(shortcut) ? (
					<div className="flex gap-1 items-center">
						{shortcut.map((shortcutKey) => (
							<kbd
								key={shortcutKey}
								className="select-none rounded border bg-gray-1 px-1.5 py-0.5 font-mono text-[11.2px] text-gray-12 shadow-xs"
							>
					...
					shortcut && (
						<kbd
							key={shortcut}
							className="select-none rounded border bg-gray-1 px-1.5 py-px font-mono text-[11.2px] text-foreground shadow-xs"
						>

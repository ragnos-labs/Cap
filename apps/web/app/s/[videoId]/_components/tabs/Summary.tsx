						...
						<div>
							...
							<div className="mb-2">
								<span className="text-xs font-semibold text-gray-8">
									Generated by {brandName} AI
								</span>
							</div>
							<div className="text-sm prose prose-sm max-w-none prose-p:my-2 prose-ul:my-2 prose-li:my-0 prose-p:text-gray-11 prose-li:text-gray-11 prose-ul:text-gray-11 prose-headings:text-gray-12 prose-strong:text-gray-12">
						...
						<div className={aiData?.summary ? "mt-6" : ""}>
							...
							<div className="divide-y">
								{aiData.chapters.map((chapter) => (
									...
									>
										<span className="w-16 text-xs text-gray-9">
